...
class Authentication:
    ...
    def login_page(self):
        ...
        with col1:
            ...
            st.markdown(
            '<p style="font-family:sans-serif;text-align:left; color:#e32b40; font-size: 35px;">XDATABYTE</p>',
            unsafe_allow_html=True
        )
        #)
            # local
...
class ContecApp:
    ...
    def home_page(self):
        st.markdown(
            '<p style="font-family:sans-serif;text-align:center; color:#42b6f5; font-size: 25px;">✨ANALYSIS ON XDATABYTE✨</p>',
            unsafe_allow_html=True
        )
        #st.divider()
        ...
        with pan1:
            st.write("")
            st.write("")
            st.write("✔️...Monthly Revenue Histogram as week wise")
            st.write("✔️...Weekly comparision with Quantity and Amount")
            st.write("✔️...Servicecode wise weekly Data view")
            st.write("✔️...A Statistical view of 2025 Data ")
            st.write("✔️...An Analysis on 2025 Dataset")
    ...
    def alfa(self):
        ...
        with col3:
            invoice_code = st.text_input("🔑 Invoice Code", value=" ") # provide 'ROKU'
...
#-----------------------------------------------------------------------------------------------------------
    ...
    def delta(self):
        ...
        st.markdown(
            '<p style="font-family:sans-serif;text-align:center; color:#e32bda; font-size: 25px;">📊✨ X DATABYTE DATA SET - 2025 ✨📊</p>',
            unsafe_allow_html=True
        )
        ...
        if df is not None and not df.empty:
            try:
                ...
                if not all(col in df.columns for col in required_cols):
                    ...
                    st.subheader("📌Analysis on  Dataset - 2025")
